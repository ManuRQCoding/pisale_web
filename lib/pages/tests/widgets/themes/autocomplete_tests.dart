...
class AutocompleteTestsData extends StatelessWidget {
  AutocompleteTestsData({Key? key, required this.handleOnSelect})
      : super(key: key);
              ...
              child: Scrollbar(
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (context, i) {
                    ...
                    return ListTile(
                      onTap: () => onSelected(e),
                      title: Text(e.get('title').toString()),
